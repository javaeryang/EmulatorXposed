...
public class StatusInstallerFragment extends Fragment {
    ...
    private void addLocalButton(LinearLayout layout){

        View view = getActivity().getLayoutInflater().inflate(R.layout.info, null);



        TextView textView = view.findViewById(R.id.info_text);
        textView.setText("适用于安卓模拟器5.0~8.1, Custom By Javaer");

        TextView wx = view.findViewById(R.id.info_wx);
        wx.setText("微信: yy960076413 (点击安装离线版) ");
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
                showActionDialog(view.getContext(), "Version 89", FrameworkZips.Type.INSTALLER);
            }
        });
